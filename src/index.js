...
const headers = {
    fileMatch: /^(gif|png|jpg|js|css|json|html)$/ig,
    maxAge: 60 * 60
};
...
module.exports  = {
    ...
    router: function (method, str, req, res) {
        ...
        if ((callback = routerExist(str,method))) {
            ...
            fileExist("public/"+str+"index.html", function(){
                staticFile(req,res,"public/"+str+"index.html","html");
            },function(){
                if(routerpool["/404"]){
    ...
    start:function(port){
        ...
        http.createServer(function(req, res){
            ...
            if (ext.match(headers.fileMatch)) {
                ...
                that.staticFile(req,res,pathN,ext);
                return;
            } else if(fs.existsSync("public/"+pathN+"/index.html")){
                that.render(req, res, pathN+"index.html")
                return;
            } else{
